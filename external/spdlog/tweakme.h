...
// the kernel HZ. Uncomment to use it instead of the regular clock.
//
...
// pattern. This will prevent spdlog from quering the clock on each log call.
//
...
// spdlog::drop() spdlog::register()). Use only if your code never modifes
// concurrently the registry. Note that upon creating a logger the registry is
// modified by spdlog..
//
