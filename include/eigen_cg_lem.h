...
#ifndef PIPE_NETWORK_EIGEN_CG_LEM_H
#define PIPE_NETWORK_EIGEN_CG_LEM_H
#include <exception>
#include <iostream>
...
//! \brief Eigen GMRES solver class using Eigen
    class EigenCG_LEM : public Solver {
    public:
        ...
        EigenCG_LEM(unsigned max_iter, double tolerance) : Solver(max_iter, tolerance) {}
    ...
    protected:
        ...
        Eigen::VectorXd precondition_jacobian();


        //! Return the type of assembler for Factory
        //! \retval assembler_type Eigen assembler
        std::string assembler_type() const override { return "Eigen_CG_LEM"; }
    };
}  // namespace pipenetwork

#endif //PIPE_NETWORK_EIGEN_CG_LEM_H
